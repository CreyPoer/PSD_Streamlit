...
fitur = data.drop(columns=['quality'], axis= 1)
...
if st.button("Cek Prediksi"):
    ...
    st.text('Prediksi : ')
    prediksi = rfmodel.predict([[Fixed_Acidity,Volatile_Acidity,Citric_Acid,Residual_Sugar,Chlorides,Free_Sulfur_Dioxide,Total_Sulfur_Dioxide,Density,pH,Sulphates,Alcohol]])
    if prediksi[0] == 0:
